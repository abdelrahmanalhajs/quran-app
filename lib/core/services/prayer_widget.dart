...
/// Pushes the day's prayer times to the Android home-screen widget
/// ([PrayerWidgetProvider]), which then shows the next prayer and a live
/// countdown to it. The native side picks "next" relative to the current
/// time, so it advances through the day on its own — this just needs to be
/// called whenever the times are (re)computed.
class PrayerWidget {
